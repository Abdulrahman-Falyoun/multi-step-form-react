...
export const makeDeleteRequest = (url: string, config?: AxiosRequestConfig | undefined) => AxiosAPI.delete(url, config)
export const makeGetRequest = (url: string, config?: AxiosRequestConfig | undefined) => AxiosAPI.get(url, config)
