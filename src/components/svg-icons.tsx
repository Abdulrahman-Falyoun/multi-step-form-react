...
import {ReactComponent as ImportedHappyMankSVG} from '../assets/icons/svg/happy-man.svg';
...
export const HappyManSVGIcon = SVGIcon({ svg: ImportedHappyMankSVG, style: { width: '2rem !important', height: '2rem !important'} });
